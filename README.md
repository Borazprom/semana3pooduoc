...
Verifica que los archivos .txt (si los hay) estén correctamente ubicados dentro del directorio data/.

Ejecuta el archivo Main.java desde el paquete app.

Sigue las instrucciones que aparecerán en la consola para interactuar con el sistema.
